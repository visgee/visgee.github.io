        ...
        var getPaths = function(){
            for(var i = 0; i < flights.length; i++){
                ...
                for(var j = 0; j < numControlPoints; j ++){
                    ...
                    colors[j * 6 + 0 + lineIndex] = 0.0234;
                    colors[j * 6 + 1 + lineIndex] = 0.855;
                    colors[j * 6 + 2 + lineIndex] = 0.965;
                    colors[j * 6 + 3 + lineIndex] = 0.0234;
                    colors[j * 6 + 4 + lineIndex] = 0.855;
                    colors[j * 6 + 5 + lineIndex] = 0.965;
                }
...
//Create the final Object3d to add to the scene
        ...
        function flightPointCloud() {
            ...
            for (var i = 0; i < num_points; i++) {
                ...
                point_colors[3 * i + 0] = Math.random();
                point_colors[3 * i + 1] = Math.random();
                point_colors[3 * i + 2] = Math.random();
